...
public class AWSIoTMQTTApplication
{
    public static void main(String[] args) {
        SpringApplication.run(AWSIoTMQTTApplication.class, args);
    }
}
*/
...
import com.techscribbler.messaging.NonBlockingPublishListener;
import com.techscribbler.messaging.TestTopicListener;
import com.techscribbler.messaging.util.CommandArguments;
import com.techscribbler.messaging.util.SampleUtil;
